...
public class PacketInRemoveContainer implements IPacketIn {
    @Override
    public void readPacket(PacketBuffer packetBuffer) {
        ...
        if (currentScreen instanceof SlotUIScreen) {
            ((SlotUIScreen) currentScreen).removeContainer(componentContainer);
        }
        if (currentScreen instanceof CommonUIScreen) {
            ((CommonUIScreen) currentScreen).removeContainer(componentContainer);
        }
    }
}
